...
Many application programmers are realizing the need to open their core
...
logic you've created in your application. It's simple, either JSON- or XML-based (we're
